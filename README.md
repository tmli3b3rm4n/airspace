...
1. From project root:
   2. `docker compose up --build`
      ...
      4. **Note**: It may fail a few times until db is ready for connections.  There are three services but one is used just to load data into database and then exits.
